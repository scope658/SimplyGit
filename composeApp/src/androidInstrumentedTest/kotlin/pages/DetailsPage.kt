...
class DetailsPage(private val composeTestRule: ComposeTestRule) : AbstractPage(composeTestRule) {
    ...
    val issuesTitle = composeTestRule.onNodeWithTag("issues_title", useUnmergedTree = true)
    val issuesIcon = composeTestRule.onNodeWithTag("issues_icon", useUnmergedTree = true)
    val issuesCount = composeTestRule.onNodeWithTag("issues_count", useUnmergedTree = true)
    val programmingLanguage = composeTestRule.onNodeWithTag("programming_language")
    val repFiles = composeTestRule.onNodeWithTag("repo_files", useUnmergedTree = true)
